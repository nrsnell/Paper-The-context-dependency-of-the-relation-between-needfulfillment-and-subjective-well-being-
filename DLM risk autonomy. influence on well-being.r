...
onaf_var<-as.matrix(diary_risk_student[,c("v3","v14")])
## v3 = autonomie school
...
regressionweights_autonomy <- ddply(diary_risk_student, "filled_out_by_id", dlmfunction)
...
pirateplot(formula = regrvalue ~ type,
           data = betas_autonomy,
           main = "Risk group: relation between different sources of autonomy and well-being",
